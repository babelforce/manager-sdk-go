...
func (r *ApplicationsResource) List(ctx context.Context, q ListApplicationsQuery) iter.Seq2[managerapi.Application, error] {
	return func(yield func(managerapi.Application, error) bool) {
		...
		for {
			...
			if data.Pagination == nil || len(data.Items) == 0 || page >= pageCount(data.Pagination.Pages) {
				return
			}
			page++
		}
...
func (r *ApplicationsResource) Clone(ctx context.Context, id string) (*managerapi.ApplicationItemResponse, error) {
	resp, err := r.gc.CloneApplicationWithResponse(ctx, id)
	if err != nil {
		return nil, err
	}
	return result(resp.JSON201, resp.HTTPResponse, resp.Body)
...
func (r *ApplicationsResource) BulkUpdate(ctx context.Context, body managerapi.BulkUpdateApplicationsRequest) (*managerapi.DefaultV2MessageResponse, error) {
	resp, err := r.gc.BulkUpdateApplicationsWithResponse(ctx, body)
	if err != nil {
		return nil, err
	}
	return result(resp.JSON200, resp.HTTPResponse, resp.Body)
...
func (r *ApplicationsResource) ListActions(ctx context.Context) (*managerapi.ObjectListResponse, error) {
	resp, err := r.gc.ListApplicationActionsWithResponse(ctx, nil)
	if err != nil {
		return nil, err
	}
	return result(resp.JSON200, resp.HTTPResponse, resp.Body)
...
func (r *ApplicationsResource) ListErrors(ctx context.Context) (*managerapi.ObjectListResponse, error) {
	resp, err := r.gc.ListApplicationErrorsWithResponse(ctx)
	if err != nil {
		return nil, err
	}
	return result(resp.JSON200, resp.HTTPResponse, resp.Body)
...
// AllLocalAutomations returns an iterator over every local automation across all applications,
// auto-paginating across pages (GET /api/v2/automations/local). The Page field of params is managed
// by the auto-paginator, so leave it unset.
func (r *ApplicationsResource) AllLocalAutomations(ctx context.Context, params managerapi.ListAllLocalAutomationsParams) iter.Seq2[managerapi.LocalAutomation, error] {
	return func(yield func(managerapi.LocalAutomation, error) bool) {
		...
		for {
			p.Page = &page
			resp, err := r.gc.ListAllLocalAutomationsWithResponse(ctx, &p)
			if err != nil {
				yield(zero, err)
				return
			}
